...
3. 請用以下結構回答，除非所選經文完全不適用，否則每段都要有實質內容：
...
4. 如屬舊約，指出希伯來文/亞蘭文背景；如屬新約，指出希臘文背景，有猶太或亞蘭語境時只作背景提醒，不要誇大。
5. 回答要完整、詳細、有教育講道者的用途；不是簡短靈修、不是代寫講章，但要足以幫助講道者建立解經方向。
6. 若篇幅需要取捨，優先保留「逐節解釋」、「原文與文法觀察」和「講道與教導方向」，不要只留下籠統應用。
